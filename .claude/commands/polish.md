...
Lead with `ui-quality-loop`. Load domain skills as each step requires (`frontend-judgment`, `design-tokens`, `ui-components`, `anti-ai-slop`, `accessibility`, `frontend-testing`, audit chain).
