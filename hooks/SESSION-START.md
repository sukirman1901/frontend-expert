...
- Build chain reminder includes **`responsive`** + **`motion`** (+ **`marketing`** if landing; hand-roll from `motion-families.md` / `landing-sections.md`)
- Audit chain includes responsive + motion when animated + marketing when landing
