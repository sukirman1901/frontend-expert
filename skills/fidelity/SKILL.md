...
- No design source (blank-canvas → `design-direction` only)
...
2. **Structure first** — layout model, hierarchy, type ladder, Auto Layout Fill/Hug (`responsive`) before pixel nits
...
Full compare workflow: `references/fidelity.md`.  
