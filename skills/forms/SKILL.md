...
| **Selects** | Product filters / status pickers: prefer **custom** select (see `components`) — not bare native OS chrome |
...
6. **Mobile** — full-width primary submit; adequate tap targets (`responsive`)
...
`references/forms.md`. A11y: `accessibility`. Responsive: `responsive`.
