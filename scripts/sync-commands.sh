...
check_skills ui design-direction prototype design-foundations tokens components anti-slop-code responsive motion anti-slop-design polish accessibility marketing
check_skills design design-foundations anti-slop-design polish tokens responsive accessibility performance fidelity devtools motion motion-inspection marketing
...
for ev in \
  ...
  components anti-slop-code prototype motion-inspection
do
