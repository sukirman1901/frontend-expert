...
- Agents: `agents/design-reviewer.md`, `agents/ui-developer.md`
- Commands: `/design`, `/ui`, `/test-ui` — **optional** (see `.claude/commands/`)
...
4. Tests when asked → `frontend-testing`
5. Audit when asked → design-reviewer skill chain; never fabricate visual scores
